...
public class SimpleRopRequestContext implements RopRequestContext {
    ...
    private AppKeyContext appKeyContext;
	...
	public AppKeyContext getAppKeyContext() {
		return appKeyContext;
	}


	public void setAppKeyContext(AppKeyContext appKeyContext) {
		this.appKeyContext = appKeyContext;
	}
